...
StudioMeyer GEO works best with the rest of the suite. All products share the same account via Magic Link.

## MCP Server Products

| Product | Tools | Connect | Pricing |
|---------|-------|---------|---------|
| **[Memory](https://github.com/studiomeyer-io/studiomeyer-memory)** | 56 | `memory.studiomeyer.io/mcp` | Free / $29 / $49 |
...
119 tools, 21 slash commands, 5 skills, 3 subagents. [Marketplace repo](https://github.com/studiomeyer-io/studiomeyer-marketplace).
...
GEO monitors how AI platforms see your brand. Memory stores check history across sessions (use `/geo_track_over_time`). CRM tracks the clients you run GEO audits for. Crew's CMO persona helps interpret results and plan content strategy.
